...
# Replacing colors
sed -i -e 's/shade1 = .*/shade1 = #00000000/g' $PDIR/config.ini
sed -i -e 's/shade2 = .*/shade2 = #00000000/g' $PDIR/config.ini
sed -i -e 's/shade3 = .*/shade3 = #00000000/g' $PDIR/config.ini
sed -i -e 's/shade4 = .*/shade4 = #00000000/g' $PDIR/config.ini
sed -i -e 's/shade5 = .*/shade5 = #00000000/g' $PDIR/config.ini
sed -i -e 's/shade6 = .*/shade6 = #00000000/g' $PDIR/config.ini
#sed -i -e 's/bg = .*/bg = #141C21/g' $PDIR/config.ini
# Restarting polybar
$LAUNCH &
