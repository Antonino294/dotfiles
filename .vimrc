...
autocmd FileType markdown nnoremap <silent> <F7> :execute 'silent !pandoc -t html5 --css /home/antonino/Build-Folder/Unused-Stuff/M5.css % -o %:r.pdf --mathml'<CR>
autocmd FileType markdown nnoremap <silent> <F6> :execute 'silent !pandoc % -o %:r.pdf'<CR>
